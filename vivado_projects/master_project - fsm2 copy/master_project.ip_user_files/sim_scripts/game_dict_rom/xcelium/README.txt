...
#
# Generated by export_simulation on Wed Jun 08 00:15:52 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './game_dict_rom.sh' script.

./game_dict_rom.sh -reset_run
...
./game_dict_rom.sh -noclean_files

For more information on the script, please type './game_dict_rom.sh -help'.
