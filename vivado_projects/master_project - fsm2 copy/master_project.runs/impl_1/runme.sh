...
HD_PWD='C:/Users/mubar/Documents/ENGS31/es31-wordle/vivado_projects/master_project - fsm2 copy/master_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WORDLE_TOP_LEVEL_SHELL2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WORDLE_TOP_LEVEL_SHELL2.tcl -notrace
