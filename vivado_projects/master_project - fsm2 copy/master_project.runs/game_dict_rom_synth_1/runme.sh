...
HD_PWD='C:/Users/mubar/Documents/ENGS31/es31-wordle/vivado_projects/master_project - fsm2 copy/master_project.runs/game_dict_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_dict_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_dict_rom.tcl
