...
HD_PWD='C:/Users/mubar/Documents/ENGS31/es31-wordle/vivado_projects/rx_tx_comm/rx_tx_comm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_tx_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_tx_shell.tcl -notrace
