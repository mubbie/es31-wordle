...
HD_PWD='C:/Users/mubar/Documents/ENGS31/es31-wordle/vivado_projects/check_guess/check_guess.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CheckGuess.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CheckGuess.tcl
