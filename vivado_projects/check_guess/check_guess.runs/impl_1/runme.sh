...
HD_PWD='O:/ES31/es31-wordle/vivado_projects/check_guess/check_guess.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CheckGuess.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CheckGuess.tcl -notrace
