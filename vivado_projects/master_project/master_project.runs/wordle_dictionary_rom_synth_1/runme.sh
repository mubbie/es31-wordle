...
HD_PWD='C:/Users/mubar/Documents/ENGS31/es31-wordle/vivado_projects/master_project/master_project.runs/wordle_dictionary_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wordle_dictionary_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wordle_dictionary_rom.tcl
