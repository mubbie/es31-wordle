...
#
# Generated by export_simulation on Fri Jun 03 13:14:11 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './wordle_dictionary_rom.sh' script.

./wordle_dictionary_rom.sh -reset_run
...
./wordle_dictionary_rom.sh -noclean_files

For more information on the script, please type './wordle_dictionary_rom.sh -help'.
